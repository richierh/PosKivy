...
class PosKasir(MDScreen):
    ...
    def pressed(self,t):
        ...
        # self.myproduct = []
        # self.myproductselected.clear()
        # self.myproductselected = [self.baca_item,self.baca_keterangan_item]
        self.myproduct.append(self.baca_item)
        self.myproduct.append(self.baca_keterangan_item)
        self.ids.screenmanagerproduct.current='itemcardproduct'
        self.ids.itemcardshow.mylabelproduk.text = str(f"{self.myproduct[0]}\n{self.myproduct[1]}")
